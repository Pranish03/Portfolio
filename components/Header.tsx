...
export default function Header() {
  ...
  return (
    <header className="bg-white flex items-center gap-1 border border-zinc-200 shadow-lg max-w-min px-1.5 py-1 mx-auto my-6 rounded-full text-[14px] text-zinc-800">
      <Link
